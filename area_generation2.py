...
class TerrainMeshGenerator:
    def __init__(self, physical_size_m, hill_path_npy, obj_output_path, macro_z_scale, bump_path_npy, micro_z_scale, road_path):
    ...
    def process(self):
        ...
        self.apply_micro_displacement_png(self.obj_output_path, self.obj_output_path, self.road_path, 0)
    ...
    def apply_micro_displacement_png(self, obj_input_path, obj_output_path, micro_heightmap_path, micro_z_scale=2.0):
        img = Image.open(micro_heightmap_path).convert("L")  # convert to grayscale
...
terrain_size = 500
macro_z_scale = 16.0
micro_z_scale = 0 #this was 10 and road was 2


hill_path_npy = "Terrain_generation/output/full.npy"
bump_path_npy = "F:/IsaacSim/Terrain_generation/textures/dirt2/displacement.png"
road_path = "Terrain_generation/output/roadMap1024.png"
mesh_output_path = "Terrain_generation/output/full.obj"

mesh = TerrainMeshGenerator(terrain_size, hill_path_npy, mesh_output_path, macro_z_scale, bump_path_npy, micro_z_scale, road_path)
mesh.process()
